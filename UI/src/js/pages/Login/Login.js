      ...
      formContent = (
        <div className="container">
              <div className="form-group">
                  {errorMessage}
                <input className="form-control" defaultValue="" placeholder="Enter a User Name..." ref="email" type="text" />
               </div>
               <div className="form-group">
                  <input className="form-control" defaultValue="" placeholder="Enter a Password..." ref="password" type="password" />
                </div>
